...
export const COLORS = ['#B8BB26', '#FABD2F', '#83A598', '#D3869B', '#8EC07C', '#FBF1C7'];
export const COLORS1 = ['#c5d5ea', '#759eb8', '#7392B7', '#B3C5D7', '#D8E1E9'];
export const COLORS2 = ['#8D5A97', '#907F9F', '#A4A5AE', '#B0C7BD', '#B8EBD0'];
